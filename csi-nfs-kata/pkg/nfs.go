...
var globalK8sClientset *kubernetes.Clientset
...
func (n *Driver) Run(testMode bool) {
	...
	/* to tell K8s to create Kata containers */
	err = initK8sClient()
	if err != nil {
		klog.Fatalf("Fatal: failed to initialize Kubernetes client: %v", err)
	}
